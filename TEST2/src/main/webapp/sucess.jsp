...
<div class="miu3">
	<h1>Successfull!</h1><br><br>
	Add another item
	<button><a href="http://localhost:8090/TEST2/stockInsert.jsp">Click here!</a></button>
	<br><br>
	Main page
	<button><a href="http://localhost:8090/TEST2/MainStockManager.html">Click here!</a></button>
